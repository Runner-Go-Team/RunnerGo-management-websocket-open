...
type ListPlansReq struct {
	TeamID string ` form:"team_id" binding:"required,gt=0" json:"team_id,omitempty"`
	Page   int    `form:"page,default=1" json:"page"`
	Size   int    `form:"size,default=10" json:"size"`

	Keyword      string `form:"keyword" json:"keyword"`
	StartTimeSec int64  `form:"start_time_sec" json:"start_time_sec"`
	EndTimeSec   int64  `form:"end_time_sec" json:"end_time_sec"`

	TaskType int32 `form:"task_type" json:"task_type"`
	TaskMode int32 `form:"task_mode" json:"task_mode"`
...
type GetPlanConfReq struct {
	TeamID string `form:"team_id" binding:"required,gt=0" json:"team_id"`
	PlanID string `form:"plan_id" binding:"required,gt=0" json:"plan_id"`
}
